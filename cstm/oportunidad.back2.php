...
value="'.$dato["name"]."|".$dato["quantity_c"]."|".number_format($dato["list_price_c"],4)."|".$dato["invoice_store_c"]."|".$dato["expiration_c"]."|".number_format($dato["unite_price_c"],4)."|".$dato["sheet_c"]."|".$dato["id"]."|".$dato["description"]."|".$dato["serial_number_c"].'">'.$dato["name"].'</option>';
	}
	echo '</select>';?>
