...
<input type="hidden" name="Certificado" value="00001000000406203896">
...
<td width="37.5%">
<span id="name">
<input type="text" name="rep_name"  id="rep_name" value=" <?php echo $rec->name; ?> " size="75"  class="required"   >
...
<span id="ownership">
<input type="text" name="rep_billing_address_street"  id="rep_billing_address_street" value="<?php echo $rec->billing_address_street; ?>" maxlength="150"  size="75"  class="required"   >
</span>
...
<span id="activity_c">
<input type="text" name="rep_billing_address_in_c" id="rep_billing_address_in_c"  value="<?php echo $rec->billing_address_in_c; ?>" size="75"      >
</span>
</span>
</td>
<td scope="row" width="12.5%">
...
<td width="37.5%">
<span id="phone_office">
<input type="text" name="rep_billing_address_colonia_c"   id="rep_billing_address_colonia_c" value="<?php echo $rec->billing_address_colonia_c; ?>" size="75" >
...
<td width="37.5%">
<span id="billing_scheme_c">
<input type="text" name="rep_billing_address_town_c" id="rep_billing_address_town_c" value="<?php echo $rec->billing_address_town_c; ?>" size="75"  class="required" >
...
<td width="37.5%">
<span id="industry">
<input type="text" name="rep_billing_address_city" id="rep_billing_address_city" value="<?php echo $rec->billing_address_city; ?>" size="75"   class="required">
 </span>
</td>
<td scope="row" width="12.5%">
Estado</td>
<td width="37.5%">
<span id="account_category_c">
<input type="text" name="rep_billing_address_state" id="rep_billing_address_state" value="<?php echo $rec->billing_address_state; ?>" size="75"   class="required" >
...
<span id="docs_attached_c">
<input type="text" name="rep_billing_address_country" id="rep_billing_address_country" value="<?php echo $rec->billing_address_country; ?>" size="75"  class="required" >
...
<td width="37.5%">
<span id="documents_c">
<input type="text" name="rep_billing_address_postalcode" id="rep_billing_address_postalcode" value="<?php echo $rec->billing_address_postalcode; ?>" size="75"   class="required"  >
...
<TR>
<TD><?php echo $cantidad =$partida->acquired_credits_c; ?>

 
 
<TD> <?php echo $partida->name; ?></TD>

<TD><?php  $unit =((($partida->amount)/(1-($partida->discount_c /100)))/1.16/$cantidad); echo number_format($unit,6); ?></TD>
...
<option label="Efectivo." value="01">Efectivo.</option>
<option label="Cheque nominativo." value="02">Cheque nominativo.</option>
<option label="Transferencia electrónica de fondos." value="03">Transferencia electrónica de fondos.</option>
<option label="Tarjeta de Crédito." value="04">Tarjeta de Crédito.</option>
<option label="Monedero Electrónico." value="05">Monedero Electrónico.</option>
<option label="Dinero electrónico" value="06">Dinero electrónico</option>
<option label="Vales de despensa." value="08">Vales de despensa.</option>
<option label="Tarjeta de Débito." value="28">Tarjeta de Débito.</option>
<option label="Tarjeta de Servicio." value="29">Tarjeta de Servicio.</option>
<option label="Otros." value="99">Otros.</option>
</select>
...
<td width="37.5%">
<input type="text" name="l_expedicion" id="l_expedicion" size="55" value="<?php echo $emi->q14_c; ?>"  >
</td>
<td scope="row" width="12.5%">
Regimen fiscal
</td>
