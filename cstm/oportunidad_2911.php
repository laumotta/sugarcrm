...
if(isset($_POST["categoria"])){
	...
	$query_ciudades = "select name, list_price_c,quantity_c, invoice_store_c ,expiration_c, unite_price_c,sheet_c, id, description, serial_number_c from cstm_products inner join cstm_products_cstm 
...
value="'.$dato["name"]."|".$dato["quantity_c"]."|".number_format($dato["list_price_c"],2)."|".$dato["invoice_store_c"]."|".$dato["expiration_c"]."|".number_format($dato["unite_price_c"],3)."|".$dato["sheet_c"]."|".$dato["id"]."|".$dato["description"]."|".$dato["serial_number_c"].'">'.$dato["name"].'</option>';
	}
	echo '</select>';?>
