							...
							<div <id="PART" class="detail view">
								...
								<TABLE WIDTH="100%" ALIGN="rigth"   class="list view" border="1">
									...
									{	
										?>
										<TR>
										<TD><?php echo $cantidad =$partida->acquired_credits_c; ?> <!--cantidad-->
											<td><?php echo $cantidad =$partida->claveunidad_c; ?></td> <!--clave unidad est-->
											<td><?php echo $cantidad =$partida->unidadmedida_c; ?></td> <!--unidad de media-->
											<td><?php echo $cantidad =$partida->clve_prod_ser; ?></td> <!--clve de prod/serv-->
											<td><?php echo $cantidad =$partida->numero_ident; ?></td> <!--num de identifi-->
											<TD> <?php echo $partida->descrip; ?></TD> <!--descripcion-->

											<TD><?php  $unit =((($partida->amount)/(1-($partida->discount_c /100)))/1.16/$cantidad); echo number_format($unit,6); ?></TD><!--precio unitario-->

											<TD><?php $imp = $unit* $cantidad;  $desc =($imp*$partida->discount_c )/100;  echo $partida->discount_c; ?></TD> <!-- descuento -->

											<TD><?php $impnto = $unit*$cantidad, $impnto=$impnto*$partida->discount_c echo number_format($impnto,3); ?></TD> <!--importe neto cantidad * precio uni-->
										...
										<table id="partidas_imp" cellspacing="0">
									...
									{	
										?>
											<tr>
												...
												<td width="7.5%" id="base">base</td>
												<td width="7.5%" id="tipo_imp">IVA</td>
												<td width="7.5%" id="tipo_fact">TASA</td>
												<td width="7.5%" id="tasa_cuo" value=""> <?php echo $tasa_cuo->discount_c echo ($tasa_cuo); ?></td>
												<td width="7.5%">
													<?php $imp = $unit*$tasa_cuo, $imp=$unit*$tasa_cuo->discount_c echo number_format($imp,3); ?>
												</td>
											</tr>
											<?php 
									...
									<table id="impuestos_globales" cellspacing="0">
										<div <id="Impuestos_Globales" class="detail view">
										<h4>IMPUESTOS GLOBALES</h4>
										<TABLE WIDTH="100%" ALIGN="rigth"   class="list view" border="1">
									...
									{	
										?>
											<tr>
												...
												<td><!--mostrar el total de la sumatoria de tasa cuota e importe de la partida de impuestos --></td>

												<td><?php echo ($TOTAL_IMP); ?></td> <!-- checar-->
