...
<script type="text/javascript">
	$(document).ready(function(){
		...
		// });
		$("#customFields").on('click', function deleteRow(remCF) {
    	remCF.parent().parent().remove();
		});
...
<BODY>
	...
	<div id="main">
		<div id="content">	
			...
			<form action="?layout2=true" method="POST"  name="EditView" id="EditView"   >
					...
					<div id="LBL_ACCOUNT_INFORMATION" class="detail view">
						...
						<tr>
							...
							<tr>
								...
								<td width="">
									<select name="regimen_fiscal" id="regimen_fiscal" title="" class="required">
						...
						<table id="detailpanel_4" cellspacing="2">
							<div id="LBL_PANEL_ASSIGNMENT" class="detail view">
								...
								<tr>
									...
									<td width="">	
									<input type="text" name="rep_red_fis" id="rep_red_fis" value="<?php if($rec->pais_c !='MEX'){ echo $rec->pais_c; } ?>" size="60">
										</td>
									...
									<tr>
										...
										Uso CFDI</td>
										<td width="">
											<select name="uso_cfdi" id="uso_cfdi" class="required">
	...
	<div id="PART" class="detail view">
		...
		<TABLE WIDTH="100%" ALIGN="rigth"   class="list view" border="1">
			...
			{	
				...
				$impnto= round(($punit*$cantidad),2); 

				$desc =round(((($punit*$cantidad)/100)*$partida->discount_c),2);
					...
					$importe_global = $importe_global+ round($tot,2);
				?>
					<TR>
	...
	<div id="PART" class="detail view">
		...
		<TABLE WIDTH="80%" ALIGN="rigth"   class="list view" border="1">
			...
			{	
				...
				$importeglobal= ($importeglobal+round($tot,2));
							
				if($base != 0 ){
				?>
				<tr>
					<td width="5%" id="tipo" value=""><?php  echo $tipo;?></td>
					<td width="5%" id="base"><?php echo round($base,2);?></td><!--Base=importeneto -descuento -->
					<td width="5%" id="tipo_imp"><?php echo ($tipo_imp); ?></td>
					<td width="5%" id="tipo_fact"><?php echo ($tipo_fact); ?></td>
					<td width="5%" id="tasa_cuo" value=""><?php echo ($tasa_cuo); ?></td>
					<td width="5%"><?php  echo round($tot,2) ;?></td>
				</tr>
				<?php 
			
				}
			}	
				$globales= array('tipo' => $tipo, 'impuesto' => $tipo_imp, 'factor' => $tipo_fact, 'cuota' => $tasa_cuo , 'importe' => $importe_global);
...
<input type="hidden"  name="globales_importe" id="globales_importe" value="<?php  echo number_format($globales['importe'],2,'.','');?>"  class="required"  READONLY>
				...
				<table id="detailpanel_4" cellspacing="2">
					<div id="LBL_ACCOUNT_INFORMATION" class="detail view">
						...
						<tr>
							...
							<input type="hidden" name="NoCertificado" value="00001000000406203896">
						...
						<tr>
							...
							<td width="37.5%">
								<input type="text" name="subtotal" id="subtotal" size="60" value="<?php echo number_format($Subtotal,2, '.', '');?>"  class="required" READONLY>
							</td>
							...
							<td width="">
								<input name="Descuento" id="Descuento" size="60"  maxlength="" value="<?php echo number_format($to_descuento,2, '.', ''); ?>" class="required" READONLY>
							</td>
						</tr>
							<tr>
								<td scope="row" width="" size="30">
								...
								<tr>
									...
									<td width="">
										<select name="tipo_comprobante" id="tipo_comprobante" title="" class="required">
									...
									Metodo de Pago</td>
									<td width="">
										<select name="metodo_pago" id="metodo_pago" title="" class="required">
								...
								<tr>
									...
									<td width="">
										<input type="text" name="lugar_expedicion" id="lugar_expedicion" size="60" value="<?php echo $emi->billing_address_postalcode; ?>" class="required">
									</td>
