...
class trigger{
	...
	function sendOpp(){
		...
		case 'Soporte':
			error_log('MAIL NOTIFICACION DE Desarrollo');
			$this->sendMessage('2fe809ef-64c7-e471-3b27-4fc54bf20bf7','c426678f-9c6f-ae9c-4cab-4fc10b136440','Usuario');
			$success =true;
			break;
		...
		case 'Software':
			...
			if ($this->_bean->cstm_products_id_c=='73a2365e-faab-dbeb-27bb-503e62b5cd20'){ 
				...
				'rfc' => $this->acc->rfc_c,
				'codigo' => '1', 
				'comodin' => add_date($this->_bean->date_closed,'',$this->_bean->expiration_c,''),
	...
	function sendMessage($prospect_list_id,$template_id,$tipo){
		...
		if($emailTemp->body_html !=''){
			...
			error_log("Copiando Mail Vendedor-> ".$usr->email1);
			}
