			...
			//###### cambio para omitir el  envio de mail bienvenida 
				...
				//#@
					...
					if($success){
						...
						}else if($this->_bean->app_c=='DN'){
							$this->sendMessage('9857ef8f-c70f-e43c-0241-4fc112b796c4','d2c66dec-91da-b8df-f182-5310d8638906','Cliente' );
						}else{
				...
				//es de renta
					...
					//es de paga
					}else if(trim($this->acc->type_service_c)=='P' and $this->_bean->cstm_products_id_c=='8d33cbfb-fbd7-8bb0-0aa2-4ed7c42d86e8'){
							
							
							error_log(">>>>>>>>>>>>> Prepago a Post PAgo  <<<<<<<<<<<<<< ");
							$query = sprintf("update accounts_cstm set type_service_c='R' where id_c ='%s' ",$this->acc->id);
