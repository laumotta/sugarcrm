...
var amountc =document.getElementsByName("amount")[0].value;
...
var val4= "98c9447c-4ff9-1b33-379e-4d49a6b1dbc1";
if(resultado==valido || resultado==val3 || resultado==val4){ldelim} 
document.getElementById("release_payment_c").disabled = false;
{rdelim} 

if(resultado==val1 || resultado==val2 || resultado==val3){ldelim}
...
if(resultado==val1 || resultado==val3){ldelim} $("#unite_price_c").attr("readonly", false);
{rdelim}
